...
<div class="container">		
	...
	<div class="row">
		<div class="col-sm-2" style="width:150px">
			<img class="product_image" src="uploaded_img/<?php echo $item["image"]; ?>" style="width:100px;height:200px;padding-top:10px;">
		</div>
		<div class="col-sm-4">
	...
	<div id="ratingDetails"> 		
		<div class="row">			
			...
			<div class="col-sm-3">
			<button type="button" id="rateProduct" class="btn btn-info <?php if(!empty($_SESSION['user_id']) && $_SESSION['user_id']){ echo 'login';} ?>">Rate this school</button>
			</div>		
		</div>
		<div class="row">
			<div class="col-sm-7">
